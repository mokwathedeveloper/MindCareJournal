    ...
    if (titleInput && contentTextarea) {
        ...
        function createRestoreModal(draft) {
            ...
            window.restoreDraft = function() {
                ...
                bootstrap.Modal.getInstance(document.getElementById('restoreDraftModal')).hide();
        ...
        function showAutoSaveIndicator(status) {
            ...
            if (!indicator) {
                ...
                indicator.className = 'position-fixed bottom-0 end-0 m-3 p-2 bg-dark text-white rounded';
            ...
            if (status === 'saving') {
                indicator.innerHTML = '<i data-feather="save" class="me-1"></i>Saving...';
...
function showButtonLoading(button) {
    ...
    const loadingText = '<span class="spinner-border spinner-border-sm me-2" role="status"></span>Processing...';
